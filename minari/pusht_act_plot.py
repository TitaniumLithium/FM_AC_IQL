...
ckpt_path = f"checkpoints/pusht_best_chunk4.pt"
...
bundle = load_minari_dataset("PushT/pusht-relabel-v0", device=device,recover=False,horizon=4)
...
print("is success: ",info["success"]," ep_len ",ep_len)
